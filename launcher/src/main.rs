...
enum Quantization {
    ...
    Owq,
    // With mixed precision quantization, better inference results can be obtained by preserving key channel precision
    //but the inference speed will be limited accordingly
    Gptq,
